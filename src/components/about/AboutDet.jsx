  ...
  return (
    <section className={`aboutdet-section ${isVisible ? "animate-up" : ""}`}>
        ...
        <div className="mission-box">
          <div className="mission-vision-text">
            ...
            <p>
              ...
              ultimately the safety and security of the client’s staff, premises,
              assets and the general public is our highest priority.
            </p>
          </div>
        </div>
        ...
        <div className="vision-box">
          <div className="mission-vision-text">
            ...
            <p>
              ...
              important assets, our staff, we aim to achieve all our goals and
              exceed our clients’ expectations. Through our commitment to high
              standards it is our vision to earn the trust of our clients by
              delivering the best quality security services within the
              Philippines.
            </p>
          </div>
        </div>
        ...
        <div className="mission-box">
          <div className="mission-vision-text">
            ...
            <p>
              ...
              integrity, unselfishness, professionalism and mutual respect. For
              our staff, we offer a rewarding and challenging environment where
              personal development can flourish. We hold ourselves accountable
              to our clients, staff and partners by honouring our commitments,
              providing results and continually striving to provide the highest
      ...
      <section className="team-section">
        ...
        <p className="team-tagline">Meet the experts behind our success.</p>
